...
const SEED_CLOSED: Order[] = [
  ...
  { id: 1015, symbol: 'UNI/USD',   type: 'BUY',  status: 'FILLED',   orderType: 'SLM', price: 7.20,     quantity: 8.0,  timestamp: Date.now() - 388800000 },
  { id: 1016, symbol: 'ATOM/USD',  type: 'SELL', status: 'REJECTED', orderType: 'GTT', price: 4.95,     quantity: 15.0, timestamp: Date.now() - 475200000, rejectionReason: 'Insufficient Margin' },
  { id: 1017, symbol: 'NEAR/USD',  type: 'BUY',  status: 'FILLED',   orderType: 'SLM', price: 3.45,     quantity: 22.0, timestamp: Date.now() - 561600000 },
  { id: 1018, symbol: 'APT/USD',   type: 'SELL', status: 'REJECTED', orderType: 'GTT', price: 5.60,     quantity: 18.5, timestamp: Date.now() - 648000000, rejectionReason: 'Price Out of Range'  },
];
      ...
      <div className="ord-shell">
        ...
        <div className="ord-tabs-wrap">
          <div className="ord-tabs">
            <div
              className={`ord-tab${tab === 'open' ? ' active' : ''}`}
              onClick={() => setTab('open')}
            >
              OPEN <span className="ord-tab-badge">{openOrders.length}</span>
            </div>
            <div
              className={`ord-tab${tab === 'closed' ? ' active' : ''}`}
