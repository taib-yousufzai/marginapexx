-- Fix process_executed_position to skip inserting PNL transactions for trades resulting in exactly 0 PNL.
-- This prevents check constraint violations on the transactions table (amount > 0).
